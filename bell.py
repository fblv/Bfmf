...
cl = LINETCR.LINE()
cl.login(token="ErjIijQQKZfwH7FwkaBc.KBtylGF7T07g2h8DyG87Ja.RcYggTKYcuCm2tmAksugaiUjY17TRNMBdA4RU1KxmUk=")

ki = LINETCR.LINE()
ki.login(token="ErTfHCtOOPwZV3yWTpC8.yeeFkYzvwhoWJ52woLDjQa.vk7hMvKxMgG/YG2Q//Fx3f/0nm2SIJB0t7JNrPM19oA=")

kk = LINETCR.LINE()
kk.login(token="Erwcl5bxIzEnjVDMONia.PofXftRniBZHiiLLYC37sG.XBgD9AJcjnF9qLeGzWNlTFL6wDN/NJp9rmCVPNDw16s=")

kc = LINETCR.LINE()
kc.login(token="EryJvu7ov1E2RjnwlMH3.AI9R5QXoLIki841eZJRGWW.cUAQjnxUQH//DvTNMUgQtkqQj4QAlgYFYrl1LUJ+ZUg=")

ks = LINETCR.LINE()
ks.login(token="ErTKxVUnLSG3KLV1qu0b.fJ/2OzZsyqO7vs6/M3oIQW.su3CcA/WHFSKh3XlrPKq5g5V5Wmdxr7rjnqF7/yiXJo=")

km = LINETCR.LINE()
km.login(token="ErrO619tp0T2r13g1HFf.w2y3st77l8p+Bfx9XcVvtW.+NA9SO9J3+zJg+gH1CRILkp5isXr3ymekDS1LCsA600=")

kt = LINETCR.LINE()
kt.login(token="Er4MPrQQugFhYmI4VvNc.dmwV+8AvfCg9qISHOhivVa.yk81GmWrsPtCBGThwb05/5X1EgD3w1vsMyoajqxoQj0=")
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"u91b4d82e07fbb74ec6d87f1d620f3b8c"]
...
wait = {
    ...
    "lang":"JP",
    "tag":True,
    "comment":"Auto Like By 􀌂􀄠􏿿􀌂⚛️ F҉bL҉ V҉ic҉ky҉҉ ⚛️",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#----------------------------------------------------------      
        ...
        #-------------Fungsi Spam Start---------------------#
               ...
               cl.sendText(msg.to,"Apa salah dan dosaku, sayang cinta suciku kau buang-buang lihat jurus yang kan ku berikan jaran goyang, jaran goyang")
               ki.sendText(msg.to,"Apa salah dan dosaku, sayang cinta suciku kau buang-buang lihat jurus yang kan ku berikan jaran goyang, jaran goyang")
               kk.sendText(msg.to,"Apa salah dan dosaku, sayang cinta suciku kau buang-buang lihat jurus yang kan ku berikan jaran goyang, jaran goyang") 
               kc.sendText(msg.to,"Apa salah dan dosaku, sayang cinta suciku kau buang-buang lihat jurus yang kan ku berikan jaran goyang, jaran goyang")
               km.sendText(msg.to,"Apa salah dan dosaku, sayang cinta suciku kau buang-buang lihat jurus yang kan ku berikan jaran goyang, jaran goyang")
               kt.sendText(msg.to,"Apa salah dan dosaku, sayang cinta suciku kau buang-buang lihat jurus yang kan ku berikan jaran goyang, jaran goyang")               
               ks.sendText(msg.to,"Apa salah dan dosaku, sayang cinta suciku kau buang-buang lihat jurus yang kan ku berikan jaran goyang, jaran goyang")                
...
#----------------------------------------------------------------------------
       #-------------Fungsi Respon Start---------------------#
                ...
                ki.sendText(msg.to,"Hadir vickyQuw Sayang 😍..")
                kk.sendText(msg.to,"Stay wht you FbL V҉i҉c҉k҉y 💞..")
                kc.sendText(msg.to,"Always wht You Bebh 😍..")
                ks.sendText(msg.to,"Iya Hadir SayangQuw 😘😘..")
                km.sendText(msg.to,"Siap BeiibhhQuuuh 😍💞..")
                kt.sendText(msg.to,"Merapat piki Sayank 😍💞💞💞..")
