...
cl = LINETCR.LINE()
cl.login(token="EqWCGKVEB9QK8BhiLpEc.KBtylGF7T07g2h8DyG87Ja.PVmCoNpni9Izn0uYCrCi3W7G/f0PdvwOsUB0dpVObzc=")

ki = LINETCR.LINE()
ki.login(token="EqQGALF2X3Xz6OkXxYG5.vyZmQUg/t4JegvUZ/u/LHq.WawE9tx7I9op0nY/VFbXxC/t5Eihzh93dSyswjEkTAk=")

kk = LINETCR.LINE()
kk.login(token="EqsGBBVcup219hinK8B4.ZjmbUsl47w5LHe91KRLRza.jP7BwuYAwjBlQXUkqaCuAYvXcn9QXWwZqmydMm2X0OA=")

kc = LINETCR.LINE()
kc.login(token="EqzP1jJscPMVnhYAsDQ9.wAH5MflAAOEf+6ou5ia/2q.yU0Ub7oiYjbmRvqaTkkrGSewkSv82vlhsAcyi/vng9U=")

ks = LINETCR.LINE()
ks.login(token="Eqj7XT4sNcu39957xAn0.8g/8uz/jsn6beFZvsopHCa.Aejfp7VoS1b0afCPHTofH8Z5dgXM2FoZ2Z9I7wkDQ9I=")

km = LINETCR.LINE()
km.login(token="EqzRObN0WaOxywtdMx18.AoFWFFCuTNDAQSkg8JsYga.e6zApTn6ejEcvPjXKOuuy0qZWE8TKGj1Y2MtcGOhMo4=")

kt = LINETCR.LINE()
kt.login(token="EqHssZNhyPOsseBTAtOd.HUPeChiJJzky8xKQcJijVq.LnkMqlv3yGcSJvOrfaKnYfN32dYqSWsuwRpdjKtSYw0=")
...
helpMessage =""" 🔯Pasukan ✍V҉i҉c҉k҉y 􀔃􀄆red check mark􏿿
